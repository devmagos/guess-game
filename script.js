...
if(!guess){
    ...
    if(score > 1) {
        document.querySelector('.message').textContent = 'Guess is above allowed range! 📈';
        score--;
    ...
    if(score > 1) {
        document.querySelector('.message').textContent = 'Guess is below allowed range! 📈';
        score--;
        document.querySelector('.score').textContent = score;
    } else {
        document.querySelector('.message').textContent = 'Game over! You lost the game :(';
    ...
    if(score > 1) {
        document.querySelector('.message').textContent = guess > winningNumber ? 'Too high! 📈' : 'Too low! 📉';
        score--;
        document.querySelector('.score').textContent = score;
    } else {
        document.querySelector('.message').textContent = 'Game over! You lost the game :(';
